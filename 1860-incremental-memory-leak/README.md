<h2><a href="https://leetcode.com/problems/incremental-memory-leak/?envType=problem-list-v2&envId=simulation">1860. Incremental Memory Leak</a></h2><h3>Medium</h3><hr><p>You are given two integers <code>memory1</code> and <code>memory2</code> representing the available memory in bits on two memory sticks. There is currently a faulty program running that consumes an increasing amount of memory every second.</p>
