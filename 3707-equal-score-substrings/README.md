<h2><a href="https://leetcode.com/problems/equal-score-substrings/?envType=problem-list-v2&envId=prefix-sum">3707. Equal Score Substrings</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> consisting of lowercase English letters.</p>
